...
-- Modifico los parametros del atributo id_usr --
alter table persona_deposito
modify column id_usr int(4) unsigned zerofill not null auto_increment;
...
CREATE TABLE detalles(
    ...
    d_modelo	varchar(30),
    d_añoLanz	year,
    d_Pant_inch decimal unsigned,
	d_RAM_tipo	varchar(15),
	d_DSK_tipo	varchar(4),
